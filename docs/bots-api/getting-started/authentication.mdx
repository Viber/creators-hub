...
sidebar_position: 2
---
import AuthTokenImg from './img/authToken.png'

# Authentication

To use the Viber Bots API, you need to provide a unique and secret authentication token,<br/> 
also known as the application key. This token acts as an identifier for your Viber account<br/>
...
<img src={AuthTokenImg} width="40%" height="auto"/>
